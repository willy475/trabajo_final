...
if ($id == '' || $token == '') {
    ...
    if ($token == $token_tmp) {
        ...
        if ($sql->fetchColumn() > 0) {
            ...
            $rutaImg = $dir_imagenes . 'imag.webp';

            $imagenes = array();
            $dir = dir($dir_imagenes);

            while (($archivo = $dir->read()) != false) {
                if ($archivo != 'imag.webp' && (strpos($archivo, 'webp') || strpos($archivo, 'jpg'))) {
            ...
            <div class="row">
                ...
                <div class="col-md-6 order-md-2">
                    ...
                    <div class="d-grid gap-3 col-10 mx-auto">
                        <a href="./checkout.php" class="btn btn-primary" type="button">Comprar ahora</a>
                        <button class="btn btn-outline-primary" type="button" onclick="addProducto(<?php echo $id ?>,
                        '<?php echo $token_tmp; ?>')">Agregarn al carrito</button>
                    </div>
